...
<head>
    ...
    <link rel="prefetch" href="{{ route('permits') }}">
    <link rel="prefetch" href="{{ route('revisions') }}">
    <link rel="prefetch" href="{{ route('user.profile') }}">
    ...
    <style>
        ...
        [wire\:loading\.delay\.shortest] { display: none; }
        [wire\:loading\.delay\.shorter] { display: none; }
        [wire\:loading\.delay\.short] { display: none; }
        [wire\:loading\.delay\.long] { display: none; }
        [wire\:loading\.delay\.longer] { display: none; }
        [wire\:loading\.delay\.longest] { display: none; }
    ...
    <nav class="bg-white shadow-lg border-t border-gray-200 fixed bottom-0 left-0 right-0 z-50" style="position: fixed !important; bottom: 0 !important;">
        <div class="max-w-md mx-auto px-4">
            <div class="flex justify-around items-center py-3">
                <a href="{{ route('home') }}" wire:navigate class="flex flex-col items-center justify-center min-w-[60px] py-2 px-3 text-gray-600 hover:text-indigo-600 transition-colors {{ request()->routeIs('home') ? 'text-indigo-600' : '' }}">
                ...
                <a href="{{ route('permits') }}" wire:navigate class="flex flex-col items-center justify-center min-w-[60px] py-2 px-3 text-gray-600 hover:text-indigo-600 transition-colors {{ request()->routeIs('permits') ? 'text-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('revisions') }}" wire:navigate class="flex flex-col items-center justify-center min-w-[60px] py-2 px-3 text-gray-600 hover:text-indigo-600 transition-colors {{ request()->routeIs('revisions') ? 'text-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('user.profile') }}" wire:navigate class="flex flex-col items-center justify-center min-w-[60px] py-2 px-3 text-gray-600 hover:text-indigo-600 transition-colors {{ request()->routeIs('user.profile') ? 'text-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
